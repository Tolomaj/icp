/****************************************************************************
** Meta object code from reading C++ file 'entry.hpp'
**
...
#error "The header file 'entry.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 6, 14), // "removeButton_f"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "Entry\0removeButton_f\0"
};
...
void Entry::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->removeButton_f(); break;
        default: ;
        }
    }
    (void)_a;
