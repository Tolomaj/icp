/****************************************************************************
** Meta object code from reading C++ file 'list.hpp'
**
...
#error "The header file 'list.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 5, 9), // "add_entry"
QT_MOC_LITERAL(2, 15, 0), // ""
QT_MOC_LITERAL(3, 16, 10), // "ObjectType"
QT_MOC_LITERAL(4, 27, 4), // "type"
QT_MOC_LITERAL(5, 32, 1), // "i"
QT_MOC_LITERAL(6, 34, 12), // "remove_entry"
QT_MOC_LITERAL(7, 47, 2) // "id"

    },
    "List\0add_entry\0\0ObjectType\0type\0i\0"
    "remove_entry\0id"
};
...
void List::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->add_entry((*reinterpret_cast< ObjectType(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 1: _t->remove_entry((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
