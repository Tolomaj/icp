...
public:
    ...
    void print(){
        Mediator::get_instance().notify_DBG_draw_line(this->a().x,this->a().y,this->b().x,this->b().y ,Qt::red);
        Mediator::get_instance().notify_DBG_draw_line(this->b().x,this->b().y,this->c().x,this->c().y ,Qt::green);
